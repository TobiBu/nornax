"""Checks for the public Hermite-6 Diffrax solve helper."""

from __future__ import annotations

import jax.numpy as jnp

from nornax import solve_adaptive_hermite6_to_time
...
def test_solve_adaptive_hermite6_to_time_runs_from_raw_arrays() -> None:
    """The public Hermite-6 helper should initialize and reach the target time."""
    result = solve_adaptive_hermite6_to_time(
